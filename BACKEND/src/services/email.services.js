...
const sendPasswordResetEmail = async (email, code) => {
    try {
        // Email remitente: usa el dominio personalizado verificado en Resend
        const fromEmail = 'noreply@mg.hospedajedigital.me';
        
        // Email destino: envía al email real del usuario
