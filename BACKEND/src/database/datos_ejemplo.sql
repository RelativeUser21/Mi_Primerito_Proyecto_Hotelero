...
(1, 'Spa y Masajes', 'Relajantes tratamientos con aceites esenciales', 60, 2, 80000, 1),
(2, 'Restaurante', 'Restaurante con comida local e internacional', 120, 20, 0, 1),
(3, 'Piscina', 'Acceso a piscina climatizada al aire libre', 480, 50, 0, 1),
(4, 'WiFi', 'Conexión a internet de alta velocidad', 1440, 10, 0, 1),
(5, 'Gimnasio', 'Gimnasio completamente equipado', 360, 15, 0, 1),
(6, 'Servicio a la Habitación', 'Pedidos de comida y bebidas', 45, 4, 15000, 1),
(7, 'Tour Guiado', 'Tours guiados por la ciudad', 240, 12, 50000, 1),
(8, 'Lavandería', 'Servicio de lavandería y tintorería', 1440, 5, 20000, 1),
(9, 'Transporte', 'Servicio de transporte al aeropuerto', 60, 4, 35000, 1),
(10, 'Bar y Cocktails', 'Bar con amplia carta de cocktails', 180, 30, 0, 1);
